...
=end 
  ...
  def self.remove_green(filename)
    begin
      il = ImageList.new
      temp = ImageList.new
  ...
  def self.merge_background(filename, bg_fname)
    begin
      il = ImageList.new
  ...
  def self.save_image(filename, img)
    begin
  ...
  def self.save_screen(filename, img)
    begin
